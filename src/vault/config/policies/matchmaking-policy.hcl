# Policy for matchmaking service
...
# Matchmaking data storage in KV (example - adjust path as needed)
path "kv/data/matchmaking/*" {
...
path "kv/data/matchmaking-service/django-config" {
  capabilities = ["read"]
}